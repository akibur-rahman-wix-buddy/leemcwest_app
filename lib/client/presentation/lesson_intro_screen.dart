      ...
      child: Column(
        ...
        children: const [
          Text('Why Music Theory Needs a Fresh Start',
            ...
            style: TextStyle(fontFamily: _cinzel, fontSize: 24, fontWeight: FontWeight.w700, color: _navy, height: 1.3)),
          SizedBox(height: 16),
          Text('And why everything you\'re about to learn exists',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 14, color: _navyMuted, height: 1.6)),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          const Text('Music theory has spent centuries naming things.',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 14.5, color: _navy, height: 1.8)),
          const SizedBox(height: 16),
          RichText(textAlign: TextAlign.center, text: const TextSpan(
            style: TextStyle(fontFamily: _cinzel, fontSize: 14.5, color: _navy, height: 1.8),
            children: [
              TextSpan(text: 'Labels. Scales. Chord names.', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: ' Useful — but they describe what harmony is called, not how it '),
              TextSpan(text: 'behaves', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: '.'),
            ],
          )),
          const SizedBox(height: 16),
          const Text(
            ...
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 14.5, color: _navyLight, height: 1.8)),
          const SizedBox(height: 16),
          const Text(
            'why does this chord feel like it wants to move there?',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 15, fontWeight: FontWeight.w700, color: _navy, height: 1.7)),
      ...
      child: Column(
        ...
        children: [
          RichText(textAlign: TextAlign.center, text: const TextSpan(
            style: TextStyle(fontFamily: _cinzel, fontSize: 14.5, color: _navy, height: 1.8),
            children: [
              TextSpan(text: 'Functional Numeric Harmony', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: ' doesn\'t name chords. It tracks '),
              TextSpan(text: 'motion', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: '.'),
            ],
          )),
          const SizedBox(height: 16),
          RichText(textAlign: TextAlign.center, text: const TextSpan(
            style: TextStyle(fontFamily: _cinzel, fontSize: 14.5, color: _navy, height: 1.8),
            children: [
              TextSpan(text: 'Every note has a gravitational role — pulling toward home, pushing away, or holding tension. FNH makes that gravity '),
              TextSpan(text: 'visible', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: '.'),
            ],
          )),
          const SizedBox(height: 20),
          const Text('No contradictions. No guesswork.',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 15, fontWeight: FontWeight.w700, color: _navy, height: 1.8)),
        ...
        children: [
          RichText(textAlign: TextAlign.center, text: const TextSpan(
            ...
            children: [
              ...
              TextSpan(text: 'twelve tones', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: '.'),
            ],
          )),
          const SizedBox(height: 18),
          RichText(textAlign: TextAlign.center, text: const TextSpan(
            ...
            children: [
              ...
              TextSpan(text: 'never changes', style: TextStyle(fontWeight: FontWeight.w700)),
              TextSpan(text: ' — yet contains '),
              TextSpan(text: 'every harmonic possibility', style: TextStyle(fontWeight: FontWeight.w700)),
          ...
          const Text('This is your foundation. Everything builds from here.',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: _cinzel, fontSize: 14, color: _navyLight, height: 1.7)),
