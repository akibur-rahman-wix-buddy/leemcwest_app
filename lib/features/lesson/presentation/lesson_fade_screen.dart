...
class LessonFadeScreen extends StatefulWidget {
  const LessonFadeScreen({super.key});

  @override
  State<LessonFadeScreen> createState() => _LessonFadeScreenState();
}

class _LessonFadeScreenState extends State<LessonFadeScreen>
