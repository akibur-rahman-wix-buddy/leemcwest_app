...
class AdvancedInsightScreen extends StatefulWidget {
  const AdvancedInsightScreen({super.key});

  @override
  State<AdvancedInsightScreen> createState() => _AdvancedInsightScreenState();
}

class _AdvancedInsightScreenState extends State<AdvancedInsightScreen> {
  @override
