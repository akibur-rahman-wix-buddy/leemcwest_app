...
import 'package:leemcwest/features/profile/widget/thank_you_widget.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> submitForm(int rating) async {
  setState(() {
    isLoading = true;
  });

  try {
    final success = await postStoreReviewRxObj.postStoreReviewRx(
    ...
    if (success == true) {
      ...
      showThankYouModal(context, rating);
    } else {
